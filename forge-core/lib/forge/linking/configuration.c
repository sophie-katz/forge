...
frg_linking_configuration_t* frg_linking_configuration_detect() {
    frg_linking_configuration_t* configuration = frg_malloc(sizeof(frg_linking_configuration_t));
    ...
    memset(&configuration->_linker_configuration, 0, sizeof(configuration->_linker_configuration));
...
void frg_linking_configuration_set_current_linker_kind(
    ...
    switch (linker_kind) {
        case FRG_LINKING_LINKER_KIND_LD_LLD:
            mut_configuration->_linker_configuration._for_ld_lld._path = _frg_linking_get_path_ld_lld();
            found = (mut_configuration->_linker_configuration._for_ld_lld._path != NULL);
            break;
        case FRG_LINKING_LINKER_KIND_LD64_LLD:
            mut_configuration->_linker_configuration._for_ld64_lld._path = _frg_linking_get_path_ld64_lld();
            found = (mut_configuration->_linker_configuration._for_ld64_lld._path != NULL);
            break;
        case FRG_LINKING_LINKER_KIND_LLD_LINK:
            mut_configuration->_linker_configuration._for_lld_link._path = _frg_linking_get_path_lld_link();
    ...
    if (!found) {
        ...
        memset(&mut_configuration->_linker_configuration, 0, sizeof(mut_configuration->_linker_configuration));
    }
}
