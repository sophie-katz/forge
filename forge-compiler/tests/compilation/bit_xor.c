...
} frg_test_bit_xor_parameters_t;

void _callback_on_shared_library_handle(void* mut_shared_library_handle,
                                        void* mut_user_data) {
  const frg_test_bit_xor_parameters_t* parameters
    = (const frg_test_bit_xor_parameters_t*)mut_user_data;
...
void _test_parameters(const frg_test_bit_xor_parameters_t* parameters) {
  ...
  options->name
    = "bit-operations-xor-%(returned-type-keyword)-%(left-text)-%(right-text)";
...
void test_u8_0_0() {
  frg_test_bit_xor_parameters_t parameters
    = { .left_text = "0u8",
        .expected_left
...
void test_unsupported_type_left() {
  ...
  options->name        = "bit-xor-unsupported-type-left";
...
void test_unsupported_type_right() {
  ...
  // -----------------------------------------------------------------------------------
  options->kind        = FRG_TESTING_COMPILATION_TEST_KIND_EXPECT_UNABLE_TO_VERIFY;
  options->name        = "bit-xor-unsupported-type-right";
...
void test_unsupported_type_both() {
  ...
  // -----------------------------------------------------------------------------------
  options->kind        = FRG_TESTING_COMPILATION_TEST_KIND_EXPECT_UNABLE_TO_VERIFY;
  options->name        = "bit-xor-unsupported-type-both";
