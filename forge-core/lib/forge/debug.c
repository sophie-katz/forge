...
void frg_debug_print_newline(frg_stream_output_t* mut_stream, frg_indentation_t indentation) {
...
void frg_debug_print_property(frg_stream_output_t* mut_stream, const char* label, const char* format, ...) {
    frg_stream_output_set_color(mut_stream, FRG_STREAM_OUTPUT_COLOR_BOLD);
