...
typedef struct {
  ...
  bool right;
  bool returned;
} frg_test_logical_and_parameters_t;

void _callback_on_shared_library_handle(void* mut_shared_library_handle,
                                        void* mut_user_data) {
  const frg_test_logical_and_parameters_t* parameters
    = (const frg_test_logical_and_parameters_t*)mut_user_data;
...
void _test_parameters(const frg_test_logical_and_parameters_t* parameters) {
  ...
  options->name                     = "logical-and-%(left)-%(right)";
...
void test_true_true() {
  frg_test_logical_and_parameters_t parameters
...
void test_true_false() {
  frg_test_logical_and_parameters_t parameters
    = { .left = true, .right = false, .returned = false };
...
void test_false_true() {
  frg_test_logical_and_parameters_t parameters
    = { .left = false, .right = true, .returned = false };
...
void test_unsupported_type_left() {
  ...
  options->name        = "logical-and-unsupported-type-left";
...
void test_unsupported_type_right() {
  ...
  // -----------------------------------------------------------------------------------
  options->kind        = FRG_TESTING_COMPILATION_TEST_KIND_EXPECT_UNABLE_TO_VERIFY;
  options->name        = "logical-and-unsupported-type-right";
...
void test_unsupported_type_both() {
  ...
  // -----------------------------------------------------------------------------------
  options->kind        = FRG_TESTING_COMPILATION_TEST_KIND_EXPECT_UNABLE_TO_VERIFY;
  options->name        = "logical-and-unsupported-type-both";
