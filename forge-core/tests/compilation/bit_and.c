...
} frg_test_bit_and_parameters_t;

void _callback_on_shared_library_handle(void* mut_shared_library_handle,
                                        void* mut_user_data) {
  const frg_test_bit_and_parameters_t* parameters
    = (const frg_test_bit_and_parameters_t*)mut_user_data;
...
void _test_parameters(const frg_test_bit_and_parameters_t* parameters) {
  ...
  options->name
    = "bit-operations-and-%(returned-type-keyword)-%(left-text)-%(right-text)";
...
void test_u8_0_0() {
  frg_test_bit_and_parameters_t parameters
    = { .left_text = "0u8",
        .expected_left
