...
# Proposal-<CHANGE: number the proposal>: <CHANGE: add a title>

This proposal is part of the [Forge language specification](../how-to-use.md). It uses v0 of the proposal template.
...
This proposal contains subitems:

1. <CHANGE: describe an item here>
