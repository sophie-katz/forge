...
void frg_stream_output_init() {
    frg_assert_with_message(_frg_global_stream_output_stdout == NULL && _frg_global_stream_output_stderr == NULL, "frg_stream_output_init() called twice");
...
void frg_stream_output_cleanup() {
    frg_assert_with_message(_frg_global_stream_output_stdout != NULL || _frg_global_stream_output_stderr != NULL, "frg_stream_output_init() was not called");
...
void frg_stream_output_set_console_color_enabled(
    bool enabled
) {
    if (enabled) {
...
void frg_stream_output_set_console_unicode_enabled(
    bool enabled
) {
    if (enabled) {
...
void frg_stream_output_write_character(
...
const char* frg_stream_output_choose_ascii_or_unicode(
    const frg_stream_output_t* mut_output,
    const char* ascii,
    const char* unicode
) {
    frg_assert_pointer_non_null(mut_output);
...
frg_stream_output_t* frg_stream_output_get_stdout() {
    frg_assert_with_message(_frg_global_stream_output_stdout != NULL, "frg_stream_output_init() was not called");

    return _frg_global_stream_output_stdout;
}

frg_stream_output_t* frg_stream_output_get_stderr() {
    frg_assert_with_message(_frg_global_stream_output_stderr != NULL, "frg_stream_output_init() was not called");
