...
#define frg_message_emit_fc_1_argument_expects_value(message_buffer, argument, value_name) { \
        frg_message_t* __frg_fc_1_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-1", \
...
#define frg_message_emit_fc_2_argument_expects_value_not_argument(message_buffer, argument, value_name, value) { \
        frg_message_t* __frg_fc_2_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-2", \
            "Argument '--%s <%s>' expects to have a value passed, but '%s' is an argument not a value", \
            (argument), \
            (value_name), \
            (value) \
        ); \
...
#define frg_message_emit_fc_3_invalid_choice(message_buffer, argument, option) \
    { \
        ...
        \
        for (GList* __frg_fc_3_choice = (option)->choices; __frg_fc_3_choice != NULL; __frg_fc_3_choice = __frg_fc_3_choice->next) { \
            const frg_cli_choice_t* __frg_fc_3_choice_casted = (const frg_cli_choice_t*)__frg_fc_3_choice->data; \
            g_string_append_printf( \
                __frg_fc_3_allowed_values, \
                "\n  '%s' - %s", \
...
#define frg_message_emit_fc_5_expects_only_one_source_file(message_buffer, value) { \
        frg_message_t* __frg_fc_5_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-5", \
...
#define frg_message_emit_fc_6_expected_command(message_buffer, binary_name) { \
        frg_message_t* __frg_fc_6_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-6", \
...
#define frg_message_emit_fc_7_invalid_argument_dash_dash(message_buffer) { \
        frg_message_t* __frg_fc_7_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-7", \
            "Invalid argument '--'" \
...
#define frg_message_emit_fc_8_unknown_short_argument(message_buffer, argument) { \
        frg_message_t* __frg_fc_8_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-8", \
            "Unknown argument '-%c'", \
...
#define frg_message_emit_fc_9_unknown_long_argument(message_buffer, argument) { \
        frg_message_t* __frg_fc_9_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-9", \
            "Unknown argument '--%s'", \
...
#define frg_message_emit_fc_10_long_argument_with_single_dash(message_buffer, argument) { \
...
#define frg_message_emit_fc_11_unknown_command(message_buffer, command, binary_name) { \
        frg_message_t* __frg_fc_11_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-11", \
...
#define frg_message_emit_fc_12_invalid_boolean_env_variable(message_buffer, variable_name, variable_value) { \
        frg_message_t* __frg_fc_12_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-12", \
...
#define frg_message_emit_fc_13_unknown_color_mode(message_buffer, value) { \
        frg_message_t* __frg_fc_13_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-13", \
...
#define frg_message_emit_fc_14_unknown_unicode_mode(message_buffer, value) { \
        frg_message_t* __frg_fc_14_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FC-14", \
...
#define frg_message_emit_fc_15_missing_required_argument(message_buffer, argument_long, argument_short) \
    frg_message_emit( \
        (message_buffer), \
        FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
        "FC-15", \
...
#define frg_message_emit_is_1_code_point_limit(message_buffer, source_range, code_point) \
...
#define frg_message_emit_es_5_escape_u_expects_opening_brace(message_buffer, source_range) { \
        frg_message_t* __frg_es_5_message = frg_message_emit_from_source_range( \
            (message_buffer), \
            (source_range), \
            FRG_MESSAGE_SEVERITY_ERROR, \
            "ES-5", \
...
#define frg_message_emit_es_6_escape_u_expects_closing_brace(message_buffer, source_range) { \
...
#define frg_message_emit_es_7_escape_u_expects_hex_digits(message_buffer, source_range, digit_count) { \
        ...
        frg_message_t* __frg_es_7_message = frg_message_emit_from_source_range( \
            ...
            FRG_MESSAGE_SEVERITY_ERROR, \
            "ES-6", \
            "'\\u{' must be followed by between 1 and 6 hexadecimal digits (%Lu were provided)", \
            (digit_count) \
        ); \
        \
        frg_message_emit_child( \
...
#define frg_message_emit_es_10_invalid_bit_width_for_int(message_buffer, source_range, bit_width) { \
...
#define frg_message_emit_es_11_invalid_bit_width_for_float(message_buffer, source_range, bit_width) { \
        frg_message_t* __frg_es_11_message = frg_message_emit_from_source_range( \
            (message_buffer), \
            (source_range), \
            FRG_MESSAGE_SEVERITY_ERROR, \
            "ES-11", \
...
#define frg_message_emit_fg_2_invalid_target_triple(message_buffer, target_triple, error_message) { \
        frg_message_t* __frg_fg_2_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FG-2", \
...
#define _frg_message_emit_fl_helper(message_buffer, message, executable, argv, working_directory) { \
    frg_message_emit_child( \
            (message_buffer), \
            (message), \
            FRG_MESSAGE_SEVERITY_NOTE, \
...
#define frg_message_emit_fl_1_unable_to_spawn(message_buffer, cause, executable, argv, working_directory) { \
        frg_message_t* __frg_fl_1_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FL-1", \
...
#define frg_message_emit_fl_2_exited_nonzero(message_buffer, exit_code, executable, argv, working_directory) { \
        frg_message_t* __frg_fl_2_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FL-2", \
...
#define frg_message_emit_fl_3_no_linker(message_buffer) { \
        frg_message_t* __frg_fl_3_message = frg_message_emit( \
            (message_buffer), \
            FRG_MESSAGE_SEVERITY_FATAL_ERROR, \
            "FL-3", \
            NULL, \
