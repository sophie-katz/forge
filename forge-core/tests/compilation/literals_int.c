...
void _callback_return_i32(const frg_message_buffer_t* message_buffer,
                          void* mut_shared_library) {
  TEST_ASSERT_EQUAL(0, message_buffer->warning_count);
  TEST_ASSERT_EQUAL(0, message_buffer->error_count);

  int32_t (*return_i32)()
    = frg_test_compilation_get_function(mut_shared_library, "return_i32");

  TEST_ASSERT_EQUAL(0, return_i32());
}

void test_return_i32() {
  frg_test_compilation("return_i32",
                       // Source
                       "fn return_i32() -> i32 {\n"
                       "  return 0i32;\n"
                       "}\n",
...
void _callback_return_u8(const frg_message_buffer_t* message_buffer,
                         void* mut_shared_library) {
  TEST_ASSERT_EQUAL(0, message_buffer->warning_count);
  TEST_ASSERT_EQUAL(0, message_buffer->error_count);

  int32_t (*return_u8)()
    = frg_test_compilation_get_function(mut_shared_library, "return_u8");

  TEST_ASSERT_EQUAL(0, return_u8());
}

void test_return_u8() {
  frg_test_compilation("return_u8",
                       // Source
                       "fn return_u8() -> u8 {\n"
                       "  return 0u8;\n"
                       "}\n",
...
void _callback_return_implicit(const frg_message_buffer_t* message_buffer,
                               void* mut_shared_library) {
  TEST_ASSERT_EQUAL(0, message_buffer->warning_count);
  TEST_ASSERT_EQUAL(0, message_buffer->error_count);

  int32_t (*return_implicit)()
    = frg_test_compilation_get_function(mut_shared_library, "return_implicit");

  TEST_ASSERT_EQUAL(0, return_implicit());
}

void test_return_implicit() {
  frg_test_compilation("return_implicit",
                       // Source
