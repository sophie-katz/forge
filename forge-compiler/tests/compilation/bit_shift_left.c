...
} frg_test_bit_shift_left_parameters_t;

void _callback_on_shared_library_handle(void* mut_shared_library_handle,
                                        void* mut_user_data) {
  const frg_test_bit_shift_left_parameters_t* parameters
    = (const frg_test_bit_shift_left_parameters_t*)mut_user_data;
...
void _test_parameters(const frg_test_bit_shift_left_parameters_t* parameters) {
  ...
  options->name
    = "bit-operations-shift-left-%(returned-type-keyword)-%(left-text)-%(right)";
...
void test_u8_0_0() {
  frg_test_bit_shift_left_parameters_t parameters
    = { .left_text = "0u8",
        .expected_left
...
void test_u8_1_1() {
  ...
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_u8 = 2;
...
void test_u8_1_7() {
  ...
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_u8 = 128;
...
void test_u16_1_1() {
  ...
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_u16 = 2;
...
void test_u16_1_15() {
  ...
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_u16 = 32768;
...
void test_u32_1_1() {
  ...
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_u32 = 2;
...
void test_u32_1_31() {
  ...
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_u32 = 2147483648;
...
void test_u64_1_1() {
  ...
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_u64 = 2;
...
void test_u64_1_63() {
  ...
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_u64 = 9223372036854775808LU;
...
void test_i64_max_0() {
  ...
  memset(&parameters.expected_left.value, 0, sizeof(parameters.expected_left.value));
  parameters.expected_left.value.as_i64 = 18446744073709551615LU;
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_i64 = 18446744073709551615LU;
...
void test_i64_max_1() {
  ...
  memset(
    &parameters.expected_returned.value, 0, sizeof(parameters.expected_returned.value));
  parameters.expected_returned.value.as_i64 = 18446744073709551614LU;
...
void test_unsupported_type_left() {
  ...
  options->name        = "bit-shift-left-unsupported-type-left";
...
void test_unsupported_type_right() {
  ...
  // -----------------------------------------------------------------------------------
  options->kind        = FRG_TESTING_COMPILATION_TEST_KIND_EXPECT_UNABLE_TO_VERIFY;
  options->name        = "bit-shift-left-unsupported-type-right";
...
void test_unsupported_type_both() {
  ...
  // -----------------------------------------------------------------------------------
  options->kind        = FRG_TESTING_COMPILATION_TEST_KIND_EXPECT_UNABLE_TO_VERIFY;
  options->name        = "bit-shift-left-unsupported-type-both";
