...
frg_configuration_options_t* frg_configuration_options_new_default() {
    frg_configuration_options_t* options = frg_malloc(sizeof(frg_configuration_options_t));
...
bool frg_configuration_options_parse_environment(
    ...
    if (!_frg_configuration_options_parse_environment_debug(
        mut_message_buffer,
        mut_options
    )) {
        return false;
    ...
    if (!_frg_configuration_options_parse_environment_color_mode(
        mut_message_buffer,
        mut_options
    )) {
        return false;
    ...
    if (!_frg_configuration_options_parse_environment_unicode_mode(
        mut_message_buffer,
        mut_options
    )) {
        return false;
