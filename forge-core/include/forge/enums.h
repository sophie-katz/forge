...
#define FRG_STREAM_COLOR_MODE_COUNT                                                    \
  (FRG_STREAM_COLOR_MODE_LAST - FRG_STREAM_COLOR_MODE_FIRST + 1)
...
#define FRG_MESSAGE_SEVERITY_COUNT                                                     \
  (FRG_MESSAGE_SEVERITY_LAST - FRG_MESSAGE_SEVERITY_FIRST + 1)
...
#define FRG_AST_VISITOR_STATUS_COUNT                                                   \
  (FRG_AST_VISITOR_STATUS_LAST - FRG_AST_VISITOR_STATUS_FIRST + 1)
...
#define FRG_STREAM_OUTPUT_COLOR_COUNT                                                  \
  (FRG_STREAM_OUTPUT_COLOR_LAST - FRG_STREAM_OUTPUT_COLOR_FIRST + 1)
...
#define FRG_LINKING_LINKER_KIND_COUNT                                                  \
  (FRG_LINKING_LINKER_KIND_LAST - FRG_LINKING_LINKER_KIND_FIRST + 1)
...
#define FRG_AST_VISITOR_EVENT_COUNT                                                    \
  (FRG_AST_VISITOR_EVENT_LAST - FRG_AST_VISITOR_EVENT_FIRST + 1)
