...
frg_cli_program_t* frg_config_cli_program_new() {
    ...
    frg_cli_program_add_command(
        program,
        frg_configuration_new_command_compile()
    );

    frg_cli_program_add_command(
        program,
        frg_configuration_new_command_dump_ast()
    );

    frg_cli_program_add_command(
        program,
        frg_configuration_new_command_dump_ir()
    );

    frg_cli_program_add_command(
        program,
        frg_configuration_new_command_help()
    );

    frg_cli_program_add_command(
        program,
        frg_configuration_new_command_link()
    );

    frg_cli_program_add_command(
        program,
        frg_configuration_new_command_version()
    );
