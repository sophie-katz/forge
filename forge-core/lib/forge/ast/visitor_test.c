...
frg_ast_node_t* create_ast() {
    ...
    statements = g_list_append(
        statements,
        frg_ast_node_statement_return_new(
    ...
    frg_ast_node_declaration_function_t* ast = frg_ast_node_declaration_function_new(
        ...
        (frg_ast_node_t*)frg_ast_node_statement_block_new(
            &frg_global_parsing_range_null,
            statements
        )
    );
...
frg_ast_visitor_status_t callback_enter_and_leave_enter(
    frg_ast_node_t** mut_node,
    void* mut_user_data,
    const GList* parents
) {
    TEST_ASSERT_NOT_NULL(parents);
    TEST_ASSERT_EQUAL(FRG_AST_NODE_KIND_STATEMENT_BLOCK, ((frg_ast_node_t*)parents->data)->kind);
    TEST_ASSERT_NOT_NULL(parents->next);
    TEST_ASSERT_EQUAL(FRG_AST_NODE_KIND_DECLARATION_FUNCTION, ((frg_ast_node_t*)parents->next->data)->kind);
...
frg_ast_visitor_status_t callback_enter_and_leave_leave(
    frg_ast_node_t** mut_node,
    void* mut_user_data,
    const GList* parents
) {
...
void test_enter_and_leave() {
    ...
    frg_ast_visitor_handler_t* handler = frg_ast_visitor_add_handler(
        visitor,
        FRG_AST_NODE_KIND_STATEMENT_RETURN
    );
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_ENTER] = callback_enter_and_leave_enter;
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_LEAVE] = callback_enter_and_leave_leave;
...
frg_ast_visitor_status_t callback_skip_enter_statement_return(
    frg_ast_node_t** mut_node,
    void* mut_user_data,
    const GList* parents
) {
...
frg_ast_visitor_status_t callback_skip_enter_value_add(
    frg_ast_node_t** mut_node,
    void* mut_user_data,
    const GList* parents
) {
...
void test_skip() {
    ...
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_LEAVE] = callback_skip_leave_declaration_function;

    handler = frg_ast_visitor_add_handler(
        visitor,
        FRG_AST_NODE_KIND_STATEMENT_RETURN
    );
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_ENTER] = callback_skip_enter_statement_return;
...
frg_ast_visitor_status_t callback_stop_enter_statement_return(
    frg_ast_node_t** mut_node,
    void* mut_user_data,
    const GList* parents
) {
...
frg_ast_visitor_status_t callback_stop_enter_value_add(
    frg_ast_node_t** mut_node,
    void* mut_user_data,
    const GList* parents
) {
...
void test_stop() {
    ...
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_LEAVE] = callback_stop_leave_declaration_function;

    handler = frg_ast_visitor_add_handler(
        visitor,
        FRG_AST_NODE_KIND_STATEMENT_RETURN
    );
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_ENTER] = callback_stop_enter_statement_return;
...
frg_ast_visitor_status_t callback_replace_node_enter_value_add(
    ...
    *mut_node = (frg_ast_node_t*)frg_ast_node_value_int_new_i32(&frg_global_parsing_range_null, 11);
...
void test_replace_node() {
    ...
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_ENTER] = callback_replace_node_enter_value_add;
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_LEAVE] = callback_replace_node_leave_value_add;
    ...
    TEST_ASSERT_EQUAL(
        ...
        ((frg_ast_node_statement_return_t*)((frg_ast_node_statement_block_t*)((frg_ast_node_declaration_function_t*)node)->body)->statements->data)->value->kind
    );
...
void test_replace_node_in_list() {
    ...
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_ENTER] = callback_replace_node_in_list_enter_statement_return;
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_LEAVE] = callback_replace_node_in_list_leave_statement_return;
    ...
    TEST_ASSERT_EQUAL(
        FRG_AST_NODE_KIND_VALUE_INT,
        ((frg_ast_node_t*)((frg_ast_node_statement_block_t*)((frg_ast_node_declaration_function_t*)node)->body)->statements->data)->kind
    );
...
void test_remove_node_in_list() {
    ...
    handler->event_callbacks[FRG_AST_VISITOR_EVENT_ENTER] = callback_remove_node_in_list_enter_statement_return;
    ...
    TEST_ASSERT_NULL(
        ((frg_ast_node_statement_block_t*)((frg_ast_node_declaration_function_t*)node)->body)->statements
    );
